    ...
    def monitor_inactivity(self):
        while True:
            ...
            if current_inactive_time >= self.inactive_threshold and self.alarm_level == 0:
                ...
                # Play reminder.wav in a continuous background loop
                winsound.PlaySound(REMINDER_PATH, winsound.SND_FILENAME | winsound.SND_ASYNC | winsound.SND_LOOP | winsound.SND_NODEFAULT)
            ...
            # LEVEL 2: The Penalty (60 seconds later)
                ...
                # Switch to aggressive.wav
                winsound.PlaySound(AGGRESSIVE_PATH, winsound.SND_FILENAME | winsound.SND_ASYNC | winsound.SND_LOOP | winsound.SND_NODEFAULT)
